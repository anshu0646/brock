...
public class BrockApp {

    private static final Logger log = LoggerFactory.getLogger(BrockApp.class);

    private final Environment env;

    public BrockApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(BrockApp.class);
